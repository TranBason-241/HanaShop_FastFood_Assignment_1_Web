        ...
        <nav class="pr-0 pl-0 navbar navbar-expand-md navbar-dark bg-dark main-menu" style="box-shadow:none">
            <div  class="container-fluid" >
                ...
                <div class="collapse navbar-collapse">
                    <form action="OrderDetailController" method="post" class="form-inline my-2 my-lg-0 mx-auto">
                        <input  name="txtorderDetail"  class="form-control"  aria-label="Search">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <c:set var="listProduct" value="${sessionScope.LIST_ORDER_DETAIL}"></c:set>
                                    ...
                                    <c:forEach varStatus="counter" var="product" items="${listProduct}"> 
                                        ...
                                        <tr style="text-align: center">
                                            ...
                                            <td style="padding-top: 13px"> 
                                             ...
                                             <td><h6>${product.quantity * product.price}</h6></td>
                                        </tr>
                                    </c:forEach>
                                </form>
                            ...
                            <h6 style="float: right; font-size: 40px; color: red">${total}$</h6>
                        </table>
                    </div>
                </div>
